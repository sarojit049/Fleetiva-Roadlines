...
export default function AdminDashboard() {
  ...
  const recordPayment = async (bookingId, status) => {
    try {
      ...
      toast.success(
        status === "paid" ? "Payment Recorded!" : "Payment reset to pending."
      );
      fetchData();
    } catch (error) {
  ...
  const downloadBilty = async (id) => {
    try {
      ...
      toast.success("Bilty downloaded");
    } catch {
  ...
  return (
    <DashboardLayout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Administer users, match loads with trucks, and manage bookings."
        />
      </Helmet>
